...
internal static partial class PublicApiUsageExtensions
{
    ...
    public static string ToStringFast(this Datadog.Trace.Telemetry.Metrics.PublicApiUsage value)
        => value switch
        {
            ...
            Datadog.Trace.Telemetry.Metrics.PublicApiUsage.IScope_Span => "iscope_span",
            Datadog.Trace.Telemetry.Metrics.PublicApiUsage.IScope_Close => "iscope_close",
            _ => value.ToString(),
        };
    ...
    public static Datadog.Trace.Telemetry.Metrics.PublicApiUsage[] GetValues()
        => new []
        {
            ...
            Datadog.Trace.Telemetry.Metrics.PublicApiUsage.IScope_Span,
            Datadog.Trace.Telemetry.Metrics.PublicApiUsage.IScope_Close,
        };
    ...
    public static string[] GetNames()
        => new []
        {
            ...
            nameof(Datadog.Trace.Telemetry.Metrics.PublicApiUsage.IScope_Span),
            nameof(Datadog.Trace.Telemetry.Metrics.PublicApiUsage.IScope_Close),
        };
