...
internal static partial class DistributionExtensions
{
    ...
    public static string GetName(this Datadog.Trace.Telemetry.Metrics.Distribution metric)
        => metric switch
        {
            ...
            Datadog.Trace.Telemetry.Metrics.Distribution.TraceSize => "trace_size",
            _ => null!,
        };
    ...
    public static bool IsCommon(this Datadog.Trace.Telemetry.Metrics.Distribution metric)
        => metric switch
        {
            ...
            Datadog.Trace.Telemetry.Metrics.Distribution.TraceSize => true,
            _ => false,
        };
    ...
    public static int ExpectedTags(this Datadog.Trace.Telemetry.Metrics.Distribution metric)
        => metric switch
        {
            ...
            Datadog.Trace.Telemetry.Metrics.Distribution.TraceSize => 0,
            _ => 0,
        };
