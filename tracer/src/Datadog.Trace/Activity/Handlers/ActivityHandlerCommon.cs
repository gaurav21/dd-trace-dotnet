...
namespace Datadog.Trace.Activity.Handlers
{
    internal class ActivityHandlerCommon
    {
        ...
        public static void ActivityStarted<T>(string sourceName, T activity, out ActivityMapping activityMapping)
            where T : IActivity
        {
            ...
            try
            {
                ...
                activityMapping = ActivityMappingById.GetOrAdd(activityKey, _ => new(activity.Instance!, CreateScopeFromActivity(activity, parent, traceId, spanId, rawTraceId, rawSpanId)));
            }
            catch (Exception ex)
            {
