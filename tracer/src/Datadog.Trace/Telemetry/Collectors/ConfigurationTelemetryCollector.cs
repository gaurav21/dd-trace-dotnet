    ...
    internal class ConfigurationTelemetryCollector
    {
        ...
        public ICollection<TelemetryValue> GetConfigurationData()
        {
            ...
            var data = new List<TelemetryValue>(27 + (settings.IsRunningInAzureAppService ? 5 : 0))
            {
                ...
                new(ConfigTelemetryData.AgentUrl, value: settings.Exporter.AgentUriInternal.ToString()),
...
#pragma warning restore CS0618
                ...
                new(ConfigTelemetryData.PartialflushEnabled, value: settings.Exporter.PartialFlushEnabledInternal),
                new(ConfigTelemetryData.PartialflushMinspans, value: settings.Exporter.PartialFlushMinSpansInternal),
