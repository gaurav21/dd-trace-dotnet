...
internal static class SourceType
{
    ...
    public static Tuple<byte, string> RequestHeaderName { get; } = new Tuple<byte, string>(3, "http.header.name");

    public static Tuple<byte, string> RequestHeaderValue { get; } = new Tuple<byte, string>(4, "http.header.value");
}
