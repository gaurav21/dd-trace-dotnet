...
namespace Datadog.Trace
{
    ...
    public class Tracer : ITracer, IDatadogTracer, IDatadogOpenTracingTracer
    {
        ...
        public Tracer()
        {
            TelemetryMetrics.Instance.Record(PublicApiUsage.Tracer_Ctor);
            ConfigureInternal(settings: null);
        ...
        {
            TelemetryMetrics.Instance.Record(PublicApiUsage.Tracer_Ctor_Settings);
        ...
        public static Tracer Instance
        {
            ...
            set
            {
                TelemetryMetrics.Instance.Record(PublicApiUsage.Tracer_Instance_Set);
                if (value is null)
                {
        ...
        {
            TelemetryMetrics.Instance.Record(PublicApiUsage.Tracer_Configure);
            ConfigureInternal(settings);
        }
...
#pragma warning disable DD0002 // This API is only for public usage - we don't want to document these separately, so this is fine
...
#pragma warning restore DD0002
        ...
        {
            TelemetryMetrics.Instance.Record(PublicApiUsage.Tracer_StartActive);
        ...
        {
            TelemetryMetrics.Instance.Record(PublicApiUsage.Tracer_StartActive_Settings);
        ...
        {
            TelemetryMetrics.Instance.Record(PublicApiUsage.Tracer_ForceFlushAsync);
            return FlushAsync();
        }
